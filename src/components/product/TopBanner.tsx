...
export function TopBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary via-[hsl(220,70%,45%)] to-primary py-3 px-4">
      <div className="container max-w-6xl mx-auto flex flex-wrap items-center justify-center gap-3 md:gap-6">
        ...
        <div className="flex items-center gap-2 bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-1.5">
          <Clock className="h-4 w-4 text-green-check" />
        ...
        {/* Vagas Restantes */}
        <div className="flex items-center gap-2 bg-accent text-white rounded-full px-4 py-1.5 font-bold text-sm">
          <Users className="h-4 w-4" />
          <span>Apenas <span className="font-black">{spots}</span> vagas restantes</span>
        </div>
      </div>
    </div>
  );
